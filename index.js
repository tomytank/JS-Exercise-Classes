...
class Person {
  ...
  eat(someFood){
    ...
    this.stomach.push(someFood); //= someFood;
...
class Car {
  ...
  drive(distance){
    ...
    if(distance > milesPossible){
      ...
      return `Ì ran out of fuel at ${this.odometer} miles!`;
    }
...
class Instructor extends Lambdasian {
  constructor(attrInstr){
    super(attrInstr);

    this.specialty = attrInstr.specialty;
    this.favLanguage = attrInstr.favLanguage;
    this.catchPhrase = attrInstr.catchPhrase;
  }
  demo(subject){
